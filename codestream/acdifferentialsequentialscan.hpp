...
** arithmetic coding procedure for differential scans.
**
** $Id: acdifferentialsequentialscan.hpp,v 1.4 2012-06-02 10:27:13 thor Exp $
**
*/

#ifndef CODESTREAM_ACDIFFERENTIALSEQUENTIALSCAN_HPP
#define CODESTREAM_ACDIFFERENTIALSEQUENTIALSCAN_HPP
...
/// class ACDifferentialSequentialScan
// Represents the scan including the scan header for the
// arithmetic coding procedure for differential scans.
class ACDifferentialSequentialScan : public EntropyParser {
  //
...
protected:
  ...
  void EncodeBlock(const LONG *block,LONG &prevdiff,
		   UBYTE small,UBYTE large,UBYTE blockup);
  //
  // Decode a single block.
  void DecodeBlock(LONG *block,LONG &prevdiff,
		   UBYTE small,UBYTE large,UBYTE blockup);
  //
...
private:
  ...
  //
public:
  ACDifferentialSequentialScan(class Frame *frame,class Scan *scan,UBYTE start,UBYTE stop,UBYTE lowbit);
  //
  ~ACDifferentialSequentialScan(void);
  // 
