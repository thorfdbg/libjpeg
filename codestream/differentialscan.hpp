...
**
** $Id: differentialscan.hpp,v 1.4 2012-07-15 11:59:44 thor Exp $
**
*/

#ifndef CODESTREAM_DIFFERENTIALSCAN_HPP
#define CODESTREAM_DIFFERENTIALSCAN_HPP
...
/// class DifferentialScan
// This codes the differential scan for DCT-based huffman differential
// frames in the hierarchical process.
class DifferentialScan : public EntropyParser {
  //
  ...
  //
public:
  DifferentialScan(class Frame *frame,class Scan *scan,UBYTE start,UBYTE stop,UBYTE lowbit);
  //
  ~DifferentialScan(void);
  // 
