...
** except that no prediction takes place here as this a differential
** scan.
**
** $Id: acdifferentiallosslessscan.hpp,v 1.5 2012-06-02 10:27:13 thor Exp $
**
*/

#ifndef CODESTREAM_ACDIFFERENTIALLOSSLESSSCAN_HPP
#define CODESTREAM_ACDIFFERENTIALLOSSLESSSCAN_HPP
...
class ACDifferentialLosslessScan : public EntropyParser {
  //
  ...
  // 
public:
  ACDifferentialLosslessScan(class Frame *frame,class Scan *scan,UBYTE lobit);
  //
  virtual ~ACDifferentialLosslessScan(void);
  //
