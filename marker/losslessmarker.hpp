...
**
** $Id: losslessmarker.hpp,v 1.3 2012-06-02 10:27:14 thor Exp $
**
*/

#ifndef MARKER_LOSSLESSMARKER_HPP
#define MARKER_LOSSLESSMARKER_HPP
...
// DCT shall be used. It can be used by default as it doesn't make
// much difference, but it must be used if this marker is present.
class LosslessMarker : public JKeeper {
  //
  //
public:
  //
  LosslessMarker(class Environ *env);
  //
  ~LosslessMarker(void);
  //
